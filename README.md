...
Started off with creating a schema file that includes the three tables(dept, role, and employee) on both workbench and sql file. I then created prompts to ask the user of what action they wanted to do. Each prompt had it's own separate function. 
